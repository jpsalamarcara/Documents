...
La programación genética es un campo de investigación de la computación evolutiva, en el cual, mediante el uso de un algoritmo genético se pretende optimizar, de acuerdo a una función objetivo, una población de individuos pertenecientes al dominio de algún lenguaje de programación.
